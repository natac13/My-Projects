...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    print("I am thinking of a word that", end=' ')
    ...
    while not isWordGuessed(main_word, guesses) and attempt > 0:
        ...
        current_guess = input("Please guess a letter, or even a guess: ").lower()
        ...
        if len(current_guess) == 1:
            ...
            if current_guess == main_word:
                ...
                print("That is not the correct word.", end=' ')
